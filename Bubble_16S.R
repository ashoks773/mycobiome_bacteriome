...
replicates_list <- c("X33_Didon", "X34_Boto", "X35_Ngombi", "X36_Molongo", "X37_Ngonduma", "X38_Ito", "X39_Iyiki", "X40_Epessekele", "X41_Francois", "X42_Ndidje", "X43_Wala", "X44_Zulia", "X45_Maki", "X46_Singa", "X47_Mbusa", "X49_Bonango", "X50_Bajungo", "X51_Malambo", "X52_Lindaki", "X53_Yambi", "X54_Manoi", "X55_Luma", "X56_Adamou", "X57_Yama", "X58_Abuya", "X59_Abeni", "X60_Omer", "X18", "X19", "X20", "X21", "X22", "X23", "X24", "X25", "X29", "X30", "X31", "X32", "X35", "D-H-S", "Day", "HA", "MK", "Nne", "PA", "T1", "X1FECOB", "X2FecJUDY", "X4FecTEA", "CH10", "CH11", "CH12", "CH13", "CH14", "CH15", "CH16", "CH17", "CH6", "CH7", "CH8", "CH9", "X1", "X2", "X3", "X10", "X11", "X12", "X13", "X14", "X15", "X16", "C6", "X102M", "X249M", "X251M", "X253M", "X87M", "M157", "M158", "M159", "M255", "M45", "M49", "B1", "B2", "B3", "B4", "H1", "K1", "K2", "K3", "K4", "K5", "K6", "M1", "M2", "M3", "M4", "M5", "M7", "MH10", "MH2", "MH3", "MH4", "MH5", "MH6", "MH7", "MH8", "MH9", "X1220", "X11A2", "X121B", "H10", "H100", "H12", "H2", "H3", "H4", "H5", "H6", "H7", "H9", "HB", "X157", "X1_Mata", "X10_Sopo", "X12_Makumba", "X16Susa", "X17_Mayele", "X18Lungu", "X21Mapoki", "X22_Susa", "X23Mongali7516", "X24_Mongali", "X25_Mayele", "X28Wiya", "X3_Mama", "X30_Duma", "X4_Mio", "X5Malui", "X6_samba", "X7_Tembo", "G161", "G6", "Jab", "Jab2", "Sam2", "Samson", "SCH2", "Scho2", "Shorder")
replicates_groups <- c("BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "BaAka-Human", "Bantu-Human", "Bantu-Human", "Bantu-Human", "Bantu-Human", "Bantu-Human", "Bantu-Human", "Bantu-Human", "Bantu-Human", "Bantu-Human", "Bantu-Human", "Bantu-Human", "Bantu-Human", "Bantu-Human", "Captive Western Lowland Gorilla", "Captive Western Lowland Gorilla", "USA-Human", "Captive Western Lowland Gorilla", "Captive Western Lowland Gorilla", "Captive Western Lowland Gorilla", "Captive Western Lowland Gorilla", "Captive Chimps-Hodonin", "Captive Chimps-Hodonin", "Captive Chimps-Hodonin", "Captive Chimps-Ostrava", "Captive Chimps-Ostrava", "Captive Chimps-Ostrava", "Captive Chimps-Ostrava", "Captive Chimps-Ostrava", "Captive Chimps-Ostrava", "Captive Chimps-Ostrava", "Captive Chimps-Ostrava", "Captive Chimps-Ostrava", "Captive Chimps-Ostrava", "Captive Chimps-Ostrava", "Captive Chimps-Ostrava", "Chimps", "Chimps", "Chimps", "Chimps", "Chimps", "Chimps", "Chimps", "Chimps", "Chimps", "Chimps", "Chimps", "Mangabey", "Mangabey", "Mangabey", "Mangabey", "Mangabey", "Mangabey", "Mangabey", "Mangabey", "Mangabey", "Mangabey", "Mangabey", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Mountain Gorilla", "Captive Western Lowland Gorilla", "Captive Western Lowland Gorilla", "Captive Western Lowland Gorilla", "USA-Human", "USA-Human", "USA-Human", "USA-Human", "USA-Human", "USA-Human", "USA-Human", "USA-Human", "USA-Human", "USA-Human", "USA-Human", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Western Lowland Gorilla", "Captive Western Lowland Gorilla", "Captive Western Lowland Gorilla", "Captive Western Lowland Gorilla", "Captive Western Lowland Gorilla", "Captive Western Lowland Gorilla", "Captive Western Lowland Gorilla", "Captive Western Lowland Gorilla", "Captive Western Lowland Gorilla", "Captive Western Lowland Gorilla")
...
otu_tab <- read.table("../16S_analysis/16S_feature-table.txt", header = TRUE, comment.char = "", sep = "\t")
names(otu_tab)[1] <- "OTU"

tax_tab <- read.table("../16S_analysis/16S_taxonomy_formatted.tsv", header = TRUE, comment.char = "", sep = "\t", fill = TRUE)
names(tax_tab)[1] <- "OTU"
...
png(file="Bacteria_bubble_plot.png", height = 7, width = 6, units = 'in', res = 600)
bubble_plot
dev.off()
