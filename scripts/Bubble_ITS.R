...
otu_tab <- read.table("../ITS_analysis/ITS_feature-table.txt", header = TRUE, comment.char = "", sep = "\t")
names(otu_tab)[1] <- "OTU"

tax_tab <- read.table("../ITS_analysis/ITS_taxonomy_formatted.tsv", header = TRUE, comment.char = "", sep = "\t", fill = TRUE)
names(tax_tab)[1] <- "OTU"
...
png(file="Fungi_bubble_plot.png", height = 6, width = 6, units = 'in', res = 600)
bubble_plot
dev.off()
