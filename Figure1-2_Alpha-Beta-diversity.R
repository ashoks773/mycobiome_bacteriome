...
#--- Bray-curtis distance matrices loaded from qiime2 at 1k depth were used for this analysis
setwd("~/Work/Project_16S_ITS/Combined/Rarefied_1k_for_alpha_beta-diversity/Procrustes_1k")
